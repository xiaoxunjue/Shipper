 ...
 * @Version: 1.0
 */
public class EmptyNoLoginItemAdapter extends BaseQuickAdapter<NoLoginEmptyBean.DataBean, BaseViewHolder> {
    public EmptyNoLoginItemAdapter() {
        super(R.layout.item_noidentification);
    }
    List<String> danwei= Arrays.asList("吨","方","米","件");

    @Override
    protected void convert(BaseViewHolder helper, NoLoginEmptyBean.DataBean item) {
