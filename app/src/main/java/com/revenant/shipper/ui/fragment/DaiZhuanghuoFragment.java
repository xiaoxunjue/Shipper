 ...
 */
public class DaiZhuanghuoFragment extends BaseFragment {
    Unbinder unbinder;
    ...
    public DaiZhuanghuoFragment() {
        // Required empty public constructor
    }

    public static DaiZhuanghuoFragment newInstance(String param1) {
        DaiZhuanghuoFragment fragment = new DaiZhuanghuoFragment();
