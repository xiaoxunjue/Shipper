 ...
 */
public class YiXieHuoFragment extends BaseFragment {
    Unbinder unbinder;
    ...
    public YiXieHuoFragment() {
        // Required empty public constructor
    }

    public static YiXieHuoFragment newInstance(String param1) {
        YiXieHuoFragment fragment = new YiXieHuoFragment();
