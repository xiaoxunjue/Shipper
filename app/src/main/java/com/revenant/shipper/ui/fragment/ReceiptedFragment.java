...
import com.revenant.shipper.ui.activity.ReceiptTitleActivity;
...
public class ReceiptedFragment extends BaseFragment {
    ...
    public ReceiptedFragment() {
        // Required empty public constructor
    }


    public static ReceiptedFragment newInstance(String param1) {
        ReceiptedFragment fragment = new ReceiptedFragment();
    ...
    protected int setLayoutId() {
        return R.layout.fragment_receipted;
    }
                        ...
                        if (shipperPublishedBean.getCode().equals("0")) {
                            ...
                            if (pageNum == 1) {
                                ...
                                for (int i = 0; i < shipperPublishedBean.getData().getSize(); i++) {
                                    if (shipperPublishedBean.getData().getResult().get(i).getStatus() == 1) {
