...
public class ShuCheEditNewActivity extends BaseActivity {
...
//        editgoodsinfo = (GoodsInfoEditBean) extras.getParcelable("editgoodsinfo");
        switch (type) {
            case 2:
                groupids = extras.getString("shuchegroups");
                if (type == extras.getInt("shuchetypeId")) {
...
//        setcenterTitle(mList.get(type));
    ...
    private void alerttime(TextView textView) {
        ...
        TimePickerView pvTime = new TimePickerBuilder(ShuCheEditNewActivity.this, new OnTimeSelectListener() {
            @Override
    ...
    private void alertarea(TextView textView) {
        ...
        mPicker.setOnCityItemClickListener(new OnCityItemClickListener() {
            ...
            public void onCancel() {
                ToastUtils.showLongToast(ShuCheEditNewActivity.this, "已取消");
            }
        });
    ...
    private void editgoods() {
        if (emptyText(goodsName, "请输入货物名称")) {
            ...
            edit_goods(
                    ...
                    String.valueOf(getText(timestart) + "-" + getText(timeend)),
                    String.valueOf(isInvoice ? 1 : 0),
                    "", String.valueOf(goodsid), ids, groupids
            );
        }
    }
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        if (s.getCode().equals("0")) {
                            ToastUtils.showShortToast(ShuCheEditNewActivity.this, "成功");
                            finish();
                        } else {
                            ToastUtils.showShortToast(ShuCheEditNewActivity.this, s.getMsg());
                        }
                    }
                    ...
                    public void onError(Response<String> response) {
                        ...
                        ToastUtils.showShortToast(ShuCheEditNewActivity.this, response.body());
                    }
                });
    }
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        if (s.getCode().equals("0")) {
                            ...
                            intent.setClass(ShuCheEditNewActivity.this, ShipperMainActivity.class);
