...
public class DriverTrackActivity extends AppCompatActivity implements View.OnClickListener {
...
//        moveMarker.setTotalDuration(8);//设置平滑移动的总时间
    ...
    private View getInfoWindowView(Marker marker) {
        if (infoWindowLayout == null) {
            infoWindowLayout = new LinearLayout(DriverTrackActivity.this);
            infoWindowLayout.setOrientation(LinearLayout.VERTICAL);
            title = new TextView(DriverTrackActivity.this);
            snippet = new TextView(DriverTrackActivity.this);
