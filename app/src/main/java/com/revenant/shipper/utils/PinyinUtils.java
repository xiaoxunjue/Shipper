...
public class PinyinUtils {
    ...
    public static String getping(String chinese) {
    ...
    public static PinyinUtils getInstance() {
        synchronized (PinyinUtils.class) {
            ...
            Log.w(TAG,
                    "There is no Chinese collator, PinyinUtils is disabled");
    ...
    public static String getPinYin(String hanzi) {
        ArrayList<Token> tokens = PinyinUtils.getInstance().get(hanzi);
